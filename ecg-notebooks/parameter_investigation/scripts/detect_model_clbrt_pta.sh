...
# do 
#     python ecg-notebooks/parameter_investigation/scripts/detect_model_clbrt_pta.py $TARGET --detstats --debug -r 500 -s 100 -v 21 --bgl 1 
#     python ecg-notebooks/parameter_investigation/scripts/build_arrays_for_model.py $TARGET --ratio --favg -r 500 -v 21 --bgl 1 
# done

# gw only
for TARGET in gsmf_phi0 gsmf_mchar0_log10
do 
    python ecg-notebooks/parameter_investigation/scripts/detect_model_clbrt_pta.py $TARGET --detstats --debug -r 500 -s 100 -v 21 --bgl 1 --gw_only
    python ecg-notebooks/parameter_investigation/scripts/build_arrays_for_model.py $TARGET --ratio --favg -r 500 -v 21 --bgl 1 --gw_only
