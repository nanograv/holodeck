...
# for TARGET in  mmb_scatter_dex hard_gamma_inner
# do 
...
#     python ecg-notebooks/parameter_investigation/scripts/build_arrays_for_model.py $TARGET --ratio -r 500 -v 21 --bgl 1
# done
