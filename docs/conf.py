...
project = 'holodeck'
copyright = ("2021, NANOGrav. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'holodeck', 'holodeck Documentation',
     author, 'holodeck', 'Supermassive binary black hole simulator for pulsar timing array signals and galaxy population  statistics.',
     'Miscellaneous'),
]
