...
PARAM_KEYS = {
    ...
    'gsmf_mchar0_log10': r"GSMF $\log_{10}(m_{\psi,0}/M_\odot)$",
    'gsmf_alpha0': r"GSMF $\alpha_\psi$",
    'gpf_zbeta': r"GPF $\beta_p$",
    'gpf_qgamma': r"GPF $\gamma_p$",
    'gmt_norm': r"GMT $T_0$",
    'gmt_zbeta': r"GMT $\beta_t$",
    'mmb_mamp_log10': r"MMB $\log_{10}(\alpha_{MM}/M_\odot)$",
    'mmb_plaw': r"MMB $\beta_{MM}$",
    'mmb_scatter_dex': r"MMB $\epsilon_{MM}$",
}
